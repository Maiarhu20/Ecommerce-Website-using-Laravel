...
<div class="container">
    @php
    $multiImages = App\Models\MultiImage::where('product_id', $product->id)->get();
    @endphp
        ...
        <div class="form-group">
            ...
            <div id="image-preview" class="mt-3">
                ...
                <div class="image-container" style="position: relative;">
                    <img src="{{ asset('upload/products/' . $image->image_path) }}" alt="Product Image" width="100" height="100">
                    {{-- <button type="button" class="image-delete-btn">X</button> --}}
                    {{-- <form action="{{ route('product.image.delete', $image->image_path,$image->product_id) }}" method="POST" style="position: absolute; top: 0; right: 0;">
                        @csrf
                        @method('DELETE')
